      ...
      <div id='info' className={style.container}>
         <div className={style.content}>
            <div className={style.text}>
               <h2>Узнайте, какой бюджет нужен для открытия пекарни именно под ваши требования</h2>
               <h3>Запишитесь на консультацию и узнайте:</h3>
               <ul>
                  <li>
                     <svg
                        xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-check-circle" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" id="mainIconPathAttribute" fill="#ffffff"></path> <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" id="mainIconPathAttribute" fill="#ffffff"></path>
                     </svg>
                     Бюджет на запуск</li>
                  <li>
                     <svg
                     ...
                     Количество и спецификацию необходимого оборудования</li>

                  <li>
                     <svg
                        xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-check-circle" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" id="mainIconPathAttribute" fill="#ffffff"></path> <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" id="mainIconPathAttribute" fill="#ffffff"></path>
                     </svg>
                     О плюсах и минусах разных форматов пекарен</li>

                  <li>
                     <svg
                        xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-check-circle" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z" id="mainIconPathAttribute" fill="#ffffff"></path> <path d="M10.97 4.97a.235.235 0 0 0-.02.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-1.071-1.05z" id="mainIconPathAttribute" fill="#ffffff"></path>
                     </svg>
                     Примерный срок окупаемости</li>
               </ul>
            </div>
            <div className={style.form}>
               <Form popupActive={popupActive} setPopupActive={setPopupActive} />
            </div>
         ...
         <div className={style.bottom}>
            ...
            <div className={style.contact}>
               ...
               <h3>Ждем звонка:</h3>
               <a href="tel:+7800000000" className={style.phone}>+7 800 000 000</a>
